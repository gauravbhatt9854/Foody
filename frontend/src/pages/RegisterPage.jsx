...
const RegisterPage = () => {
  ...
  const {
    ...
    },
    {
      ...
      studentId: {
        required: (value, allValues) => allValues.role === 'student' ? 'Student ID is required for students' : false,
      },
    }
  );
        ...
        >
          ...
          <div className="pt-6 mt-6 border-t border-gray-200">
            <Button
              ...
              fullWidth
              size="lg"
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-lg text-lg shadow-lg"
            >
              🍽️ Create My Foody Account
            </Button>
          </div>
